...
public class Booking {
    ...
    /**
     * Efektivni depozit posle primene protection tier multiplikatora.
     * Snapshot u trenutku kreiranja bukinga.
     *
     * <p><b>Set By:</b> BookingService.createBooking() at booking creation time.
     * <p><b>Immutable:</b> Should never be updated after initial set.
     */
    @Column(name = "effective_deposit_snapshot", precision = 19, scale = 2)
    private BigDecimal effectiveDepositSnapshot;
