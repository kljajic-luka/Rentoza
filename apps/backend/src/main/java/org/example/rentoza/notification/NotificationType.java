...
public enum NotificationType {
    ...
    // ========== ADMIN ALERTING (TASK 5) ==========

    /** Vozilo nije vraceno u roku od 24h — hitan admin alert. */
    ADMIN_ALERT_VEHICLE_NOT_RETURNED,

    /** Depozit capture nije uspeo pri checkout-u. */
    ADMIN_ALERT_DEPOSIT_CAPTURE_FAILED,

    /** Novi dispute (damage claim) podnet. */
    ADMIN_ALERT_DISPUTE_FILED,

    /** Dispute stariji od 48h bez admin akcije — SLA breach. */
    ADMIN_ALERT_DISPUTE_SLA_BREACH,

    /** Payout eskaliran na MANUAL_REVIEW. */
    ADMIN_ALERT_PAYOUT_FAILED
}
