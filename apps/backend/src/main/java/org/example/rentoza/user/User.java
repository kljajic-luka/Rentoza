...
public class User {
    ...
    /**
     * Kada je kanonski telefon verifikovan putem OTP-a.
     * NULL znaci da telefon jos nije verifikovan.
     */
    @Column(name = "phone_verified_at")
    private LocalDateTime phoneVerifiedAt;

    /**
     * Privremeni zamenjivac telefona dok se OTP ne potvrdi.
     * Kada korisnik sa vec verifikovanim telefonom unese novi broj,
     * novi broj se cuva ovde dok se ne potvrdi; stari ostaje aktivan.
     */
    @Column(name = "pending_phone", length = 20)
    private String pendingPhone;

    /**
     * Kada je pending_phone poslednji put postavljen.
     */
    @Column(name = "pending_phone_updated_at")
    private LocalDateTime pendingPhoneUpdatedAt;
    ...
    public void normalize() {
        ...
        if (pendingPhone != null) pendingPhone = pendingPhone.replaceAll("[^0-9]", "");
    }
    ...
    /**
     * Da li je kanonski telefon verifikovan (phoneVerifiedAt != null).
     */
    ...
    /**
     * Vraca telefon koji treba da primi OTP:
     * pendingPhone ako postoji, inace phone.
     */
    public String getPhoneVerificationTarget() {
        return (pendingPhone != null && !pendingPhone.isBlank()) ? pendingPhone : phone;
    }
