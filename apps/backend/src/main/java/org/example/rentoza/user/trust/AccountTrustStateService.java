...
public class AccountTrustStateService {
    ...
    public AccountTrustSnapshot snapshot(User user) {
        ...
        PhoneVerificationState phoneVerificationState = resolvePhoneVerificationState(user);
        ...
        boolean hasVerifiedPhone = user.isPhoneVerified();
        boolean canBookAsRenter = canAuthenticate && renterVerificationState.isBookable() && hasVerifiedPhone;
    ...
    public PhoneVerificationState resolvePhoneVerificationState(User user) {
