...
/**
 * Terminal booking statuses — no further transitions possible.
 * Mirrors BookingStatus.isTerminal() on the backend.
 */
...
/**
 * Check if a booking status is terminal (no further transitions possible).
 * Single source of truth — mirrors backend BookingStatus.isTerminal().
 */
