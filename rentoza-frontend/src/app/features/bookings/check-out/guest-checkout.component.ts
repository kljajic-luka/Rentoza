      ...
      <mat-stepper [linear]="true" #stepper>
        ...
        <mat-step [completed]="step1Complete()">
          ...
          <div class="step-content">
            ...
            <p class="hint">Pregledajte fotografije koje je domaćin napravio na početku putovanja.</p>
            ...
            <div class="readings-comparison">
              <div class="reading">
                ...
                <span>Početna kilometraža: <strong>{{ status?.startOdometer || 'N/A' }} km</strong></span>
              </div>
              <div class="reading">
                <mat-icon>local_gas_station</mat-icon>
                <span>Početno gorivo: <strong>{{ status?.startFuelLevel || 'N/A' }}%</strong></span>
              </div>
            </div>

            <div class="step-actions">
              <button mat-raised-button color="primary" matStepperNext (click)="markStep1Complete()">
                Nastavi
          ...
          <div class="step-content">
            ...
            <form [formGroup]="readingsForm" class="readings-form">
              <mat-form-field appearance="outline">
                ...
                <input matInput type="number" formControlName="endOdometer" [min]="status?.startOdometer || 0">
            ...
            <div class="summary">
              ...
              <div class="summary-item">
                ...
                <strong [class.negative]="calculateFuelDiff() < 0">{{ calculateFuelDiff() }}%</strong>
              </div>
            </div>
...
export class GuestCheckoutComponent {
  ...
  ngOnInit(): void {
    ...
    if (this.status?.startOdometer) {
      this.readingsForm.get('endOdometer')?.setValidators([
        Validators.required,
        Validators.min(this.status.startOdometer),
      ]);
    }
  }
  ...
  getProgressLabel(state: string): string {
    switch (state) {
      case 'compressing': return 'Kompresija...';
      case 'uploading': return 'Upload...';
      case 'validating': return 'Validacija...';
      default: return '';
    }
  }
  ...
  submitCheckout(): void {
    ...
    this.checkoutService.submitGuestCheckout(
      ...
      error: (err) => {
        this._isSubmitting.set(false);
        this.snackBar.open(
          err?.error?.message || 'Greška pri slanju checkout-a',
          'OK',
          { duration: 5000 }
        );
      },
